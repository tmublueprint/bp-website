            ...
            <div id="devCard-body">
                ...
                <ul id="devCard-text">
                    ...
                    <li>
                        ...
                        <p className="devCard-body-text">Once the product is complete, we support the nonprofit with deployment and onboarding. We ensure a smooth transition by providing documentation, training, and ongoing support as needed.</p>
                    </li>
                </ul>
            </div>
        </div>
