        ...
        <div id="projectPage-container">
            ...
            <div className="w-full max-w-[644.6px] px-4 flex flex-col items-center mx-auto gap-[100px] md:gap-[144.3px]">
                <div className="text-center flex flex-col items-center mt-[100px] md:mt-[142.2px] w-full max-w-[600px]">
                    <h1 className="text-[40px] md:text-[55.3px] mb-[13.7px] text-[#333]">Coming Soon...</h1>
                    <p className="text-[16px] md:text-[17.3px]">We're currently in the early stages of our 2025–2026 cycle and haven't launched any projects just yet,
                ...
                <div className="text-center w-full">
                    <h1 className="text-[40px] md:text-[55.3px] text-[#333]">Partner with Us</h1>
                    <p className="text-[16px] md:text-[17.3px] text-[#333]">
